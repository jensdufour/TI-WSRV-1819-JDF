...
\begin{center}
	\includegraphics[width=15cm]{Pictures/SCCM/Pre/1543483191.png}
\end{center}
\subsection{IP Instellingen}
\begin{center}
	\includegraphics[width=15cm]{Pictures/SCCM/Pre/1543483265.png}
\end{center}
\subsection{Toevoegen aan het domein}
\begin{center}
	\includegraphics[width=15cm]{Pictures/SCCM/Pre/1543483352.png}
	
	Geef als domein jenduf.gent in.
\end{center}
\begin{center}
	\includegraphics[width=15cm]{Pictures/SCCM/Pre/1543483358.png}
	
	Geef gebruikersnaam "Administrator" in en paswoord "Admin2018".
\end{center}
\begin{center}
	\includegraphics[width=15cm]{Pictures/SCCM/Pre/1543483399.png}
...
\subsection{Aanmaken gebruikers op DC1}
\begin{center}
	\includegraphics[width=15cm]{Pictures/SCCM/Users/}
\end{center}
\end{document}